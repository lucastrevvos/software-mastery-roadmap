...
const STORAGE_KEY = "software-mastery-learning-progress-v1";
...
function showCompletion() {
  el("resultContent").innerHTML =
    '<p class="eyebrow">FASE 00 CONCLUÍDA</p>' +
    '<h2>Computador como instrumento</h2>' +
    '<p>O piloto registrou Theory → Checkpoint → Workshop → Lab → Review → Quiz → Project. As próximas fases ainda estão marcadas como em construção.</p>';
...
function exportProgress() {
  ...
  anchor.href = url;
  anchor.download = "software-mastery-progress.json";
  anchor.click();
